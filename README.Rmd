...
[![CRAN status](https://www.r-pkg.org/badges/version/assistr)](https://CRAN.R-project.org/package=assistr)
<!-- badges: end -->
...
You can install the development version of assistr from [GitHub](https://github.com/) with:
